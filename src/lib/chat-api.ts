...
export async function processUserMessage(
  ...
  try {
    ...
    const wittyRedirect = [
      '😁 أنا بوت يا صديقي، معنديش عِشّة ولا طيران، بس أقدر أفيدك في المقاولات أو التسويق أو الذكاء الاصطناعي. تحب نبدأ بإيه؟',
      '🙂 لول، فهمتها! نرجع للشغل: مهتم بالذكاء الاصطناعي، التسويق، ولا المقاولات؟',
    ...
    if (isHumor) {
      if (recentHumorCount >= 1) {
        return { response: '😂 شكلك بتجربني… خلينا نرجع لموضوع شغلك: تحب أقولك عن التسويق الإلكتروني ولا المقاولات ولا حلول الذكاء الاصطناعي؟', shouldAddToHistory: false };
      }
      return { response: pick(humorReplies), shouldAddToHistory: false };
    }

    const ambiguousTriggers = ['مش فاهم', 'مش واضح', 'ايه', 'إيه', 'يعني', 'ازاي', 'إزاي', 'مم', 'نن', 'خغ'];
    ...
    const clarifyPool = [
      ...
      'طيب، هل تركّز على التسويق الإلكتروني، المقاولات، ولا الذكاء الاصطناعي؟',
